...
- **Windows**: `DesktopTodo-1.0.4-Windows.exe`
...
- **平滑窗口动画** - 打开时间选择器时窗口向下平滑扩展，easeOut 缓动过渡
- **自动收回** - 松开透明度滑块时面板自动收回
- **位置记忆** - 自动保存窗口位置和大小
- **系统托盘** - 最小化到托盘，随时呼出
- **开机自启** - 可选开机自动启动
...
1. 前往 [Releases](https://github.com/zero-but-one/DesktopTodo/releases) 页面下载 `DesktopTodo-1.0.4-Windows.exe`
2. 双击运行安装包，按提示完成安装
3. 安装完成后即可使用
